...
Plug & Play Server-Side Tracking for WooCommerce. Auto-generates DataLayer events & connects EVENTRIX CAPI instantly. No GTM required.

== Description ==

EVENTRIX is a powerful Server-Side Tracking solution designed to fix signal loss caused by iOS14, Ad Blockers, and ITP (Intelligent Tracking Prevention). By moving your tracking from the browser to the server, you ensure 99% data accuracy and improve your ROAS.
...
**EVENTRIX is different.** This plugin handles everything:
...
2.  **Connects to CAPI:** It loads the EVENTRIX SDK to send events directly to your server and Facebook Conversion API.
...
1.  Upload the `eventrix` folder to the `/wp-content/plugins/` directory.
2.  Activate the plugin through the 'Plugins' menu in WordPress.
3.  Go to **Settings > EVENTRIX**.
4.  Enter your **Tracking ID** (Found in your EVENTRIX Dashboard).
...
Yes! In the settings, you can replace the default `recordsync.cam` with your own custom domain (e.g., `track.yoursite.com`). This turns EVENTRIX into a "First-Party" tracker, which is much harder for browsers to block.

= Where do I find my Tracking ID? =
Log in to your EVENTRIX Dashboard, click on your project, and look at the project configuration fields to find the Tracking ID.